...
final class CaptchaCode extends Service
{
	...
	public static function registerRoutes(Router $router): void
	{
		...
		$router
			->get($route_path, static fn (RouteInfo $ri) => self::generateCaptchaImage(
				$ri->getContext(),
				$ri->param(self::CAPTCHA_KEY)
			))
	...
	public static function apiDoc(ApiDoc $doc): void
	{
		...
		$doc->addOperationFromRoute(
			...
			'Get Captcha Image',
			[
				$doc->response(200, 'PNG captcha image.', [
			...
			[
				'tags'        => [$tag->name],
				'operationId' => 'Assets.captcha',
				'description' => 'Get a captcha image for the given key.',
			]
		);
	}
}
