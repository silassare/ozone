<?php
	...
	class UnverifiedUserException extends BaseException
	{
		 ...
		 */
		public function __construct($message = 'OZ_ERROR_YOU_MUST_LOGIN', array $data = null, \Exception $previous = null)
		{
			parent::__construct($message, BaseException::UNVERIFIED_USER, $data, $previous);
		}
