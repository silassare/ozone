...
/**
 * Class FormResumeNotYetActiveException.
 *
 * Thrown when a resumable form session is accessed before its `notBefore()` time.
 *
 * HTTP 403 — the session exists but is not yet open for submissions.
 */
class FormResumeNotYetActiveException extends ForbiddenException
{
	/**
	 * FormResumeNotYetActiveException constructor.
	 *
