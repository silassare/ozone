...
/**
 * Class ResumableFormProvider.
 *
 * Default resumable form provider used by the {@see FormResumeRouteInterceptor}
 ...
 */
final class ResumableFormProvider extends AbstractResumableFormProvider
{
	/**
	 * {@inheritDoc}
	 */
	...
	{
		return 'oz:form:resumable:provider';
	}
