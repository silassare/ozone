...
/**
 * Class FormResumeRouteInterceptor.
 *
 ...
 */
final class FormResumeRouteInterceptor implements RouteInterceptorInterface
{
	/**
	 * FormResumeRouteInterceptor constructor.
	 */
	...
	{
		return 'oz:form:resume:route:interceptor';
	}
	...
	public function handle(): Response
	{
		...
		$providerClass = $options->resolveResumeProviderClass()
