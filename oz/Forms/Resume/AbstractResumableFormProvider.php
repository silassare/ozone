 ...
 *
 * Pure-defaults base for resumable form providers. The standalone endpoints of
 * {@see ResumableFormService} resolve providers by name through the
 * `oz.forms.providers` settings registry; a route declaring a provider class uses
 * it directly. There is no static in-process registry.
 *
 ...
 * ```
 *
 * Register in `app/settings/oz.forms.providers.php`, keyed by `getName()`:
 *
 * ```php
 * return [
