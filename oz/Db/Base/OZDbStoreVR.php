 ...
 * Class OZDbStoreVR.
 */
abstract class OZDbStoreVR extends \Gobl\DBAL\Relations\VirtualRelation
{
	/**
	 * {@inheritDoc}
	 */
	...
	{
		if ($target instanceof \OZONE\Core\Db\OZDbStore) {
			return $this->getItemRelation($target, $request, $total_records);
		}

		throw new InvalidArgumentException('Target item should be an instance of: ' . \OZONE\Core\Db\OZDbStore::class);
	}
