 ...
 * Class OZFilesCrud.
 */
abstract class OZFilesCrud implements \Gobl\CRUD\Handler\Interfaces\CRUDHandlerInterface
{
	/**
	 * {@inheritDoc}
	 */
	...
	{
		/** @var \OZONE\Core\Db\OZFile $entity */
		switch ($event) {
	 ...
	 *
	 * @param \OZONE\Core\Db\OZFile $entity
	 */
	public function onAfterCreateEntity(\OZONE\Core\Db\OZFile $entity): void
	{
	}
	 ...
	 * @param \OZONE\Core\Db\OZFile $entity
	 */
	public function onAfterReadEntity(\OZONE\Core\Db\OZFile $entity): void
	{
	}
	 ...
	 * @param \OZONE\Core\Db\OZFile $entity
	 */
	public function onBeforeUpdateEntity(\OZONE\Core\Db\OZFile $entity): void
	{
	}
	 ...
	 * @param \OZONE\Core\Db\OZFile $entity
	 */
	public function onAfterUpdateEntity(\OZONE\Core\Db\OZFile $entity): void
	{
	}
	 ...
	 * @param \OZONE\Core\Db\OZFile $entity
	 */
	public function onBeforeDeleteEntity(\OZONE\Core\Db\OZFile $entity): void
	{
	}
	 ...
	 * @param \OZONE\Core\Db\OZFile $entity
	 */
	public function onAfterDeleteEntity(\OZONE\Core\Db\OZFile $entity): void
	{
	}
}
