 ...
 */
	...
	abstract class OZSessionsController extends ORMControllerBase
	{
		...
		{
			parent::__construct(ORM::getDatabase('OZONE\OZ\Db'), OZSession::TABLE_NAME, OZSessionReal::class, OZSessionsQueryReal::class, OZSessionsResultsReal::class);
		}
		...
		{
			/** @var \OZONE\OZ\Db\OZSession|null $result */
