 ...
 * @method \OZONE\OZ\Db\OZSession[]    getAllItems(array $filters = [], int $max = null, int $offset = 0, array $order_by = [], ?int &$total = -1)
 * @method \OZONE\OZ\Db\OZSession[]    getAllItemsCustom(\Gobl\DBAL\Queries\QBSelect $qb, int $max = null, int $offset = 0, &$total = false)
