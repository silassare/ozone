<?php
	...
	abstract class OZSessionsResults implements \Countable, \Iterator
	{
		/** @var \Gobl\DBAL\Db */
		protected $db;
		/** @var \OZONE\OZ\Db\Base\OZSessionsQuery */
		 ...
		 * @param \OZONE\OZ\Db\Base\OZSessionsQuery $table_manager
		 * @param \Gobl\DBAL\QueryBuilder     $query
		 *
		 * @throws \Gobl\ORM\Exceptions\ORMException
		 */
		public function __construct(Db $db, OZSessionsQuery $table_manager, QueryBuilder $query)
		{
		...
		{
			if ($this->entity === null) {
				$this->entity = new \OZONE\OZ\Db\OZSession(false);
			}
