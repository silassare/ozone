<?php
	...
	/**
	 * Class OZClientsUsersResults
	 *
	 * @package OZONE\OZ\Db\Base
	 */
	abstract class OZClientsUsersResults implements \Countable, \Iterator
	{
		/** @var \Gobl\DBAL\Db */
		protected $db;
		/** @var \OZONE\OZ\Db\Base\OZClientsUsersQuery */
		protected $table_manager;
		/** @var \Gobl\DBAL\QueryBuilder */
		protected $query;
		/** @var int */
		protected $index = 0;
		/** @var array|null|\OZONE\OZ\Db\OZClientUser */
		protected $current = null;
		/** @var  int */
		protected $count_cache = null;
		/** @var bool */
		protected $trust_row_count = true;
		/** @var \OZONE\OZ\Db\OZClientUser */
		...
		/**
		 * OZClientsUsersResults constructor.
		 *
		 * @param \Gobl\DBAL\Db               $db
		 * @param \OZONE\OZ\Db\Base\OZClientsUsersQuery $table_manager
		 * @param \Gobl\DBAL\QueryBuilder     $query
		 *
		 * @throws \Gobl\ORM\Exceptions\ORMException
		 */
		public function __construct(Db $db, OZClientsUsersQuery $table_manager, QueryBuilder $query)
		{
		 ...
		 *
		 * @return $this|\OZONE\OZ\Db\OZClientsUsersResults
		 */
		 ...
		 *
		 * @return array|null|\OZONE\OZ\Db\OZClientUser
		 */
		...
		/**
		 * Fetches the next row into table OZClientUser class instance.
		 *
		 * @return null|\OZONE\OZ\Db\OZClientUser
		 */
		public function fetchClass()
		{
			if ($this->entity === null) {
				$this->entity = new \OZONE\OZ\Db\OZClientUser(false);
			}
		...
		/**
		 * Fetches all rows and return array of OZClientUser class instance.
		 *
		...
		public function fetchAllClass()
		{
			...
			$entity_class      = \OZONE\OZ\Db\OZClientUser::class;
