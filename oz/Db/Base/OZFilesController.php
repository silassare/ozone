<?php
	...
	abstract class OZFilesController
	{
		 ...
		 *
		 * @param \OZONE\OZ\Db\OZFilesQuery $query
		 * @param array                       $item_filters
		 *
		 * @throws \Gobl\ORM\Exceptions\ORMControllerFormException
		 */
		final protected static function applyFilters(OZFilesQuery &$query, array $item_filters)
		{
			if (empty($item_filters)) {
				return;
			}
