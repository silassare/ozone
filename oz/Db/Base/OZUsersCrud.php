 ...
 * Class OZUsersCrud.
 */
abstract class OZUsersCrud implements \Gobl\CRUD\Handler\Interfaces\CRUDHandlerInterface
{
	/**
	 * {@inheritDoc}
	 */
	...
	{
		/** @var \OZONE\Core\Db\OZUser $entity */
		switch ($event) {
	 ...
	 *
	 * @param \OZONE\Core\Db\OZUser $entity
	 */
	public function onAfterCreateEntity(\OZONE\Core\Db\OZUser $entity): void
	{
	}
	 ...
	 * @param \OZONE\Core\Db\OZUser $entity
	 */
	public function onAfterReadEntity(\OZONE\Core\Db\OZUser $entity): void
	{
	}
	 ...
	 * @param \OZONE\Core\Db\OZUser $entity
	 */
	public function onBeforeUpdateEntity(\OZONE\Core\Db\OZUser $entity): void
	{
	}
	 ...
	 * @param \OZONE\Core\Db\OZUser $entity
	 */
	public function onAfterUpdateEntity(\OZONE\Core\Db\OZUser $entity): void
	{
	}
	 ...
	 * @param \OZONE\Core\Db\OZUser $entity
	 */
	public function onBeforeDeleteEntity(\OZONE\Core\Db\OZUser $entity): void
	{
	}
	 ...
	 * @param \OZONE\Core\Db\OZUser $entity
	 */
	public function onAfterDeleteEntity(\OZONE\Core\Db\OZUser $entity): void
	{
	}
}
