<?php
	 ...
	 */
	abstract class OZAuthenticatorResults implements \Countable, \Iterator
	{
		/** @var \Gobl\DBAL\Db */
		protected $db;
		/** @var \OZONE\OZ\Db\Base\OZAuthenticatorQuery */
		protected $table_manager;
		/** @var \Gobl\DBAL\QueryBuilder */
		protected $query;
		/** @var int */
		protected $index = 0;
		/** @var array|null|\OZONE\OZ\Db\OZAuth */
		 ...
		 * @param \OZONE\OZ\Db\Base\OZAuthenticatorQuery $table_manager
		 * @param \Gobl\DBAL\QueryBuilder     $query
		 *
		 * @throws \Gobl\ORM\Exceptions\ORMException
		 */
		public function __construct(Db $db, OZAuthenticatorQuery $table_manager, QueryBuilder $query)
		{
		 ...
		 *
		 * @return $this|\OZONE\OZ\Db\OZAuthenticatorResults
		 */
		...
		/**
		 * Fetches the next row into table OZAuth class instance.
		 *
		...
		{
			if ($this->entity === null) {
				$this->entity = new \OZONE\OZ\Db\OZAuth(false);
			}
		...
		/**
		 * Fetches all rows and return array of OZAuth class instance.
		 *
		...
		public function fetchAllClass()
		{
			...
			$entity_class      = \OZONE\OZ\Db\OZAuth::class;
