 ...
 */
abstract class OZSessionsCrud implements \Gobl\CRUD\Handler\Interfaces\CRUDHandlerInterface
{
	/**
	 * {@inheritDoc}
	 */
	...
	{
		/** @var \OZONE\Core\Db\OZSession $entity */
		switch ($event) {
	 ...
	 *
	 * @param \OZONE\Core\Db\OZSession $entity
	 */
	public function onAfterCreateEntity(\OZONE\Core\Db\OZSession $entity): void
	{
	}
	 ...
	 * @param \OZONE\Core\Db\OZSession $entity
	 */
	public function onAfterReadEntity(\OZONE\Core\Db\OZSession $entity): void
	{
	}
	 ...
	 * @param \OZONE\Core\Db\OZSession $entity
	 */
	public function onBeforeUpdateEntity(\OZONE\Core\Db\OZSession $entity): void
	{
	}
	 ...
	 * @param \OZONE\Core\Db\OZSession $entity
	 */
	public function onAfterUpdateEntity(\OZONE\Core\Db\OZSession $entity): void
	{
	}
	 ...
	 * @param \OZONE\Core\Db\OZSession $entity
	 */
	public function onBeforeDeleteEntity(\OZONE\Core\Db\OZSession $entity): void
	{
	}
	 ...
	 * @param \OZONE\Core\Db\OZSession $entity
	 */
	public function onAfterDeleteEntity(\OZONE\Core\Db\OZSession $entity): void
	{
	}
}
