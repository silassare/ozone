<?php
	 ...
	 */
	abstract class OZAdministratorsResults implements \Countable, \Iterator
	{
		/** @var \Gobl\DBAL\Db */
		protected $db;
		/** @var \OZONE\OZ\Db\Base\OZAdministratorsQuery */
		protected $table_manager;
		/** @var \Gobl\DBAL\QueryBuilder */
		protected $query;
		/** @var int */
		protected $index = 0;
		/** @var array|null|\OZONE\OZ\Db\OZAdmin */
		protected $current = null;
		/** @var  int */
		protected $count_cache = null;
		/** @var bool */
		protected $trust_row_count = true;
		/** @var \OZONE\OZ\Db\OZAdmin */
		 ...
		 * @param \OZONE\OZ\Db\Base\OZAdministratorsQuery $table_manager
		 * @param \Gobl\DBAL\QueryBuilder     $query
		 *
		 * @throws \Gobl\ORM\Exceptions\ORMException
		 */
		public function __construct(Db $db, OZAdministratorsQuery $table_manager, QueryBuilder $query)
		{
		 ...
		 *
		 * @return $this|\OZONE\OZ\Db\OZAdministratorsResults
		 */
		...
		/**
		 * Fetches the next row into table OZAdmin class instance.
		 *
		...
		{
			if ($this->entity === null) {
				$this->entity = new \OZONE\OZ\Db\OZAdmin(false);
			}
		...
		/**
		 * Fetches all rows and return array of OZAdmin class instance.
		 *
		...
		public function fetchAllClass()
		{
			...
			$entity_class      = \OZONE\OZ\Db\OZAdmin::class;
