<?php
	 ...
	 */
	abstract class OZClientsResults implements \Countable, \Iterator
	{
		/** @var \Gobl\DBAL\Db */
		protected $db;
		/** @var \OZONE\OZ\Db\Base\OZClientsQuery */
		protected $table_manager;
		/** @var \Gobl\DBAL\QueryBuilder */
		protected $query;
		/** @var int */
		protected $index = 0;
		/** @var array|null|\OZONE\OZ\Db\OZClient */
		 ...
		 * @param \OZONE\OZ\Db\Base\OZClientsQuery $table_manager
		 * @param \Gobl\DBAL\QueryBuilder     $query
		 *
		 * @throws \Gobl\ORM\Exceptions\ORMException
		 */
		public function __construct(Db $db, OZClientsQuery $table_manager, QueryBuilder $query)
		{
		 ...
		 *
		 * @return $this|\OZONE\OZ\Db\OZClientsResults
		 */
		 ...
		 *
		 * @return array|null|\OZONE\OZ\Db\OZClient
		 */
		...
		/**
		 * Fetches the next row into table OZClient class instance.
		 *
		...
		{
			if ($this->entity === null) {
				$this->entity = new \OZONE\OZ\Db\OZClient(false);
			}
		...
		/**
		 * Fetches all rows and return array of OZClient class instance.
		 *
		...
		public function fetchAllClass()
		{
			...
			$entity_class      = \OZONE\OZ\Db\OZClient::class;
