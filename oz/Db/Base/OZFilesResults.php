<?php
	 ...
	 */
	abstract class OZFilesResults implements \Countable, \Iterator
	{
		/** @var \Gobl\DBAL\Db */
		protected $db;
		/** @var \OZONE\OZ\Db\Base\OZFilesQuery */
		protected $table_manager;
		/** @var \Gobl\DBAL\QueryBuilder */
		protected $query;
		/** @var int */
		protected $index = 0;
		/** @var array|null|\OZONE\OZ\Db\OZFile */
		 ...
		 * @param \OZONE\OZ\Db\Base\OZFilesQuery $table_manager
		 * @param \Gobl\DBAL\QueryBuilder     $query
		 *
		 * @throws \Gobl\ORM\Exceptions\ORMException
		 */
		public function __construct(Db $db, OZFilesQuery $table_manager, QueryBuilder $query)
		{
		 ...
		 *
		 * @return $this|\OZONE\OZ\Db\OZFilesResults
		 */
		 ...
		 *
		 * @return array|null|\OZONE\OZ\Db\OZFile
		 */
		...
		/**
		 * Fetches the next row into table OZFile class instance.
		 *
		...
		{
			if ($this->entity === null) {
				$this->entity = new \OZONE\OZ\Db\OZFile(false);
			}
		...
		/**
		 * Fetches all rows and return array of OZFile class instance.
		 *
