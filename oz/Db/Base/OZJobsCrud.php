 ...
 * Class OZJobsCrud.
 */
abstract class OZJobsCrud implements \Gobl\CRUD\Handler\Interfaces\CRUDHandlerInterface
{
	/**
	 * {@inheritDoc}
	 */
	...
	{
		/** @var \OZONE\Core\Db\OZJob $entity */
		switch ($event) {
	 ...
	 *
	 * @param \OZONE\Core\Db\OZJob $entity
	 */
	public function onAfterCreateEntity(\OZONE\Core\Db\OZJob $entity): void
	{
	}
	 ...
	 * @param \OZONE\Core\Db\OZJob $entity
	 */
	public function onAfterReadEntity(\OZONE\Core\Db\OZJob $entity): void
	{
	}
	 ...
	 * @param \OZONE\Core\Db\OZJob $entity
	 */
	public function onBeforeUpdateEntity(\OZONE\Core\Db\OZJob $entity): void
	{
	}
	 ...
	 * @param \OZONE\Core\Db\OZJob $entity
	 */
	public function onAfterUpdateEntity(\OZONE\Core\Db\OZJob $entity): void
	{
	}
	 ...
	 * @param \OZONE\Core\Db\OZJob $entity
	 */
	public function onBeforeDeleteEntity(\OZONE\Core\Db\OZJob $entity): void
	{
	}
	 ...
	 * @param \OZONE\Core\Db\OZJob $entity
	 */
	public function onAfterDeleteEntity(\OZONE\Core\Db\OZJob $entity): void
	{
	}
}
