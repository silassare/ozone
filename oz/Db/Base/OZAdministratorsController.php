<?php
	...
	abstract class OZAdministratorsController
	{
		 ...
		 *
		 * @param \OZONE\OZ\Db\OZAdministratorsQuery $query
		 * @param array                       $item_filters
		 *
		 * @throws \Gobl\ORM\Exceptions\ORMControllerFormException
		 */
		final protected static function applyFilters(OZAdministratorsQuery &$query, array $item_filters)
		{
			if (empty($item_filters)) {
				return;
			}
		...
		public function deleteOneItem(array $item_filters)
		{
			...
			if ($my_entity) {
				$my_query = new OZAdministratorsQuery();
