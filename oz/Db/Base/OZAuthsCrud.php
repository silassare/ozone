 ...
 * Class OZAuthsCrud.
 */
abstract class OZAuthsCrud implements \Gobl\CRUD\Handler\Interfaces\CRUDHandlerInterface
{
	/**
	 * {@inheritDoc}
	 */
	...
	{
		/** @var \OZONE\Core\Db\OZAuth $entity */
		switch ($event) {
	 ...
	 *
	 * @param \OZONE\Core\Db\OZAuth $entity
	 */
	public function onAfterCreateEntity(\OZONE\Core\Db\OZAuth $entity): void
	{
	}
	 ...
	 * @param \OZONE\Core\Db\OZAuth $entity
	 */
	public function onAfterReadEntity(\OZONE\Core\Db\OZAuth $entity): void
	{
	}
	 ...
	 * @param \OZONE\Core\Db\OZAuth $entity
	 */
	public function onBeforeUpdateEntity(\OZONE\Core\Db\OZAuth $entity): void
	{
	}
	 ...
	 * @param \OZONE\Core\Db\OZAuth $entity
	 */
	public function onAfterUpdateEntity(\OZONE\Core\Db\OZAuth $entity): void
	{
	}
	 ...
	 * @param \OZONE\Core\Db\OZAuth $entity
	 */
	public function onBeforeDeleteEntity(\OZONE\Core\Db\OZAuth $entity): void
	{
	}
	 ...
	 * @param \OZONE\Core\Db\OZAuth $entity
	 */
	public function onAfterDeleteEntity(\OZONE\Core\Db\OZAuth $entity): void
	{
	}
}
