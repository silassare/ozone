 ...
 * @internal
 *
 * @covers \OZONE\Core\Utils\DateTimeUtils
 */
final class DateTimeUtilsTest extends TestCase
{
	...
	public function testEndOfMonthJanuary(): void
	{
		...
		$last = $dt->endOfMonth();
		self::assertSame(31, $last->getDay());
	}
	...
	public function testEndOfMonthFebruaryNonLeapYear(): void
	{
		...
		$last = $dt->endOfMonth();
		self::assertSame(28, $last->getDay());
	}
	...
	public function testEndOfMonthFebruaryLeapYear(): void
	{
		...
		$last = $dt->endOfMonth();
		self::assertSame(29, $last->getDay());
	}
	...
	public function testEndOfMonthApril(): void
	{
		...
		$last = $dt->endOfMonth();
		self::assertSame(30, $last->getDay());
	}
	...
	public function testEndOfMonthIsImmutable(): void
	{
		...
		self::assertSame(10, $original->getDay());
	...
	public function testSubDay(): void
	{
		$dt   = DateTimeUtils::parse('2025-06-15 00:00:00', 'UTC');
		$prev = $dt->subDay();
		self::assertSame(14, $prev->getDay());
	}
	...
	public function testSubDayAcrossMonthBoundary(): void
	{
		$dt   = DateTimeUtils::parse('2025-02-01 00:00:00', 'UTC');
		$prev = $dt->subDay();
		self::assertSame(31, $prev->getDay());
	}
	...
	public function testAddDayIsImmutable(): void
	{
		...
		self::assertSame(15, $original->getDay());
		self::assertSame(16, $next->getDay());
	}
	...
	public function testLessThan(): void
	{
		...
		self::assertTrue($earlier->lessThan($later));
		self::assertFalse($later->lessThan($earlier));
		self::assertFalse($earlier->lessThan($earlier));
	}
	...
	public function testGreaterThan(): void
	{
		...
		self::assertTrue($later->greaterThan($earlier));
	...
	public function testBetweenInsideInterval(): void
	{
		...
		self::assertTrue($inside->between($start, $end));
	}
	...
	public function testBetweenAtBoundariesIsInclusive(): void
	{
		...
		self::assertTrue($start->between($start, $end));
		self::assertTrue($end->between($start, $end));
	}
	...
	public function testBetweenOutsideInterval(): void
	{
		...
		self::assertFalse($before->between($start, $end));
