...
final class FormTest extends TestCase
{
	...
	public function testToArrayKeyIsAutoGeneratedOnConstruction(): void
	{
		$form = new Form();
	...
	{
		self::assertMatchesRegularExpression('/^[0-9a-f]{16}$/', (new Form())->getVersion());
	}
	...
	public function testGetRefWithNoPrefix(): void
	{
		$form = new Form();
	...
	public function testGetRefWithPrefix(): void
	{
